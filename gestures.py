...
class Ui_new_form(object):
    def setupUi(self, new_form):
        ...
        new_form.resize(470, 336)
        self.gesture_table = QtWidgets.QTableWidget(new_form)
        self.gesture_table.setGeometry(QtCore.QRect(10, 10, 451, 271))
        ...
        item = QtWidgets.QTableWidgetItem()
        self.gesture_table.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.gesture_table.setHorizontalHeaderItem(3, item)
        self.add_gesture = QtWidgets.QPushButton(new_form)
        self.add_gesture.setGeometry(QtCore.QRect(310, 290, 151, 41))
        self.add_gesture.setObjectName("add_gesture")
        self.save_gesture = QtWidgets.QPushButton(new_form)
        self.save_gesture.setGeometry(QtCore.QRect(10, 290, 151, 41))
    ...
    def retranslateUi(self, new_form):
        ...
        item = self.gesture_table.horizontalHeaderItem(2)
        item.setText(_translate("new_form", "Добавить примеры"))
        item = self.gesture_table.horizontalHeaderItem(3)
        item.setText(_translate("new_form", "Удалить"))
